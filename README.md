...
# This repository is cumulative

Insolar contributors work on several Insolar Platform versions and their automated tests simultaneously. They all reside in different GitHub repositories.

This repository does not contain any code.

Instead, to help the world track Insolar's progress, this repository simply accumulates links to commits from:

* [MainNet 1.0](https://github.com/insolar/insolar) — Insolar Platform 1.0
* [Assured Ledger](https://github.com/insolar/assured-ledger) — Insolar Platform 2.0

# Contribute!

Feel free to fork the repositories listed above, and, inside, submit issues and pull requests!
